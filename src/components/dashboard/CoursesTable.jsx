  ...
  return (
    <VStack align="stretch" gap={4}>
      ...
      <HStack justify="space-between">
        <Text fontSize="xl" fontWeight="bold">Courses Management</Text>
        ...
        <Table.Root>
          <Table.Header>
            <Table.Row>
              ...
              <Table.ColumnHeader px={4} py={3}>Instructor</Table.ColumnHeader>
              <Table.ColumnHeader px={4} py={3}>Category</Table.ColumnHeader>
              <Table.ColumnHeader px={4} py={3}>Price</Table.ColumnHeader>
              <Table.ColumnHeader px={4} py={3}>Enrolled</Table.ColumnHeader>
          ...
          <Table.Body>
            {courses.map((course) => (
              <Table.Row key={course.id}>
                <Table.Cell px={4} py={3}>{course.title}</Table.Cell>
                <Table.Cell px={4} py={3}>{course.instructor}</Table.Cell>
                <Table.Cell px={4} py={3}>{course.category}</Table.Cell>
                <Table.Cell px={4} py={3}>${course.price}</Table.Cell>
                <Table.Cell px={4} py={3}>{course.enrolled}</Table.Cell>
